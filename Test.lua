do
	local ui = game.CoreGui:FindFirstChild("Slash")
	if ui then
		ui:Destroy()
...
function library:AddWindow(text,keybind)
    ...
    local Slash = Instance.new("ScreenGui")
    Slash.Name = "Slash"
    Slash.Parent = game.CoreGui
    Slash.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    ...
    NameHub2.Position = UDim2.new(0, 14, 0, 0)
    NameHub2.Size = UDim2.new(0, 61, 0, 27)
    NameHub2.Font = Enum.Font.GothamSemibold
    NameHub2.Text = "Slash Hub"
    NameHub2.TextColor3 = Color3.fromRGB(180, 184, 181)
    ...
    function Ui:AddTab(text)
        ...
        function uitab:AddPage()
            ...
            function main:AddSeperator(text)
                ...
                Sep1.BackgroundColor3 = Color3.fromRGB(5, 135, 38)
                ...
                Sep3.BackgroundColor3 = Color3.fromRGB(5, 135, 38)
            ...
            function main:AddButton(text,callback)
                ...
                Button.BackgroundColor3 = Color3.fromRGB(5, 135, 38)
            ...
            function main:AddDropdown(text,option,callback)
                ...
                Dropdown.BackgroundColor3 = Color3.fromRGB(5, 135, 38)
            ...
            function main:AddSlider(text,min,max,set,callback)
                ...
                local slidy = Instance.new("Frame")
                local slidies = Instance.new("TextButton")
                ...
                Slider.BackgroundColor3 = Color3.fromRGB(5, 135, 38)
                ...
                slidy.Name = "slidy"
                slidy.Parent = sliderr
                slidy.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                slidy.BackgroundTransparency = 1.000
                slidy.Size = UDim2.new(0, 258, 0, 46)

                slidies.Name = "slidies"
                slidies.Parent = sliderr
                slidies.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                slidies.BackgroundTransparency = 1.000
                slidies.Position = UDim2.new(0, 10, 0, 35)
                slidies.Size = UDim2.new(0, 238, 0, 5)
                slidies.Font = Enum.Font.SourceSans
                slidies.Text = ""
                slidies.TextColor3 = Color3.fromRGB(0, 0, 0)
                slidies.TextSize = 14.000
                ...
                bar1.Name = "bar1"
                bar1.Parent = bar
                bar1.BackgroundColor3 = Color3.fromRGB(5, 135, 38)
                ...
                slidervalue.BackgroundColor3 = Color3.fromRGB(5, 135, 38)
                ...
                slidy.MouseEnter:Connect(function()
                    TweenService:Create(
                        Slider,
                        TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
                        {BackgroundTransparency = 0}
                ...
                slidy.MouseLeave:Connect(function()
                    TweenService:Create(
                        Slider,
                        TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
                        {BackgroundTransparency = 0.5}
                ...
                slidies.MouseButton1Down:Connect(function()
            ...
            function main:AddToggle(text,config,callback)
                ...
                Toggle.BackgroundColor3 = Color3.fromRGB(5, 135, 38)
...
local MainTab2 = win:AddTab("Main2")
local MainTab3 = win:AddTab("Main3")
local MainTab4 = win:AddTab("Main4")
local MainTab5 = win:AddTab("Main5")
local MainTab6 = win:AddTab("Main6")
