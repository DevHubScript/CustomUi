...
RunService.RenderStepped:Connect(function(dt)
	...
	for i, data in pairs(rainbowObjects) do
		local obj = data.obj
		if obj then
...
function PleumPleum:Window(text,maincolor)
   ...
   table.insert(rainbowObjects, {obj = Hashtag, type = "Image"})
   ...
   table.insert(rainbowObjects, {obj = MinimizeIcon, type = "Image"})
   ...
   UserName.Text = ""
   UserTag.Text = game.Players.LocalPlayer.Name
   table.insert(rainbowObjects, {obj = UserTag, type = "Text"})
   ...
   table.insert(rainbowObjects, {obj = EditBtn, type = "Text"})
   ...
   function PleumPleum:Notification(titletext, desctext, btntext)
   ...
   function ServerHold:Server(text,textgame, img)
      ...
      table.insert(rainbowObjects, {obj = ServerTitle, type = "Text"})
      ...
      table.insert(rainbowObjects, {obj = GlowFrame, type = "Background"})
      ...
      table.insert(rainbowObjects, {obj = Glow, type = "Image"})
      ...
      table.insert(rainbowObjects, {obj = Hashtag, type = "Text"})
      ...
      table.insert(rainbowObjects, {obj = ChannelTitle, type = "Text"})
      ...
      table.insert(rainbowObjects, {obj = GlowChannel, type = "Image"})
      ...
      function ChannelHold:Channel(text)
         ...
         table.insert(rainbowObjects, {obj = ChannelBtnTitle, type = "Text"})
         ...
         function ChannelContent:Button(text,callback)
            ...
            Button.Text = text
            table.insert(rainbowObjects, {obj = Button, type = "Text"})
         ...
         function ChannelContent:Toggle(text,default,callback)
            ...
            table.insert(rainbowObjects, {obj = ToggleTitle, type = "Text"})
            ...
            Toggle.MouseButton1Click:Connect(function()
               if toggled == false then
                  ...
                  TweenService:Create(ToggleFrame,TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{BackgroundColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)}):Play()
         ...
         function ChannelContent:Slider(text, min, max, start, callback)
            ...
            table.insert(rainbowObjects, {obj = SliderTitle, type = "Text"})
            ...
            table.insert(rainbowObjects, {obj = CurrentValueFrame, type = "Background"})
            ...
            table.insert(rainbowObjects, {obj = Zip, type = "Background"})
            ...
            table.insert(rainbowObjects, {obj = GlowBubble, type = "Image"})
         ...
         function ChannelContent:Dropdown(text, list, callback)
            ...
            table.insert(rainbowObjects, {obj = DropdownTitle, type = "Text"})
            ...
            table.insert(rainbowObjects, {obj = CurrentSelectedText, type = "Text"})
            ...
            table.insert(rainbowObjects, {obj = ArrowImg, type = "Image"})
            ...
            for i,v in next, list do
               ...
               ItemText.Text = v
               table.insert(rainbowObjects, {obj = ItemText, type = "Text"})
         ...
         function ChannelContent:Colorpicker(text, preset, callback)
            ...
            table.insert(rainbowObjects, {obj = ColorpickerTitle, type = "Text"})
            ...
            ColorpickerFrameOutline.BackgroundTransparency = 0.4
            table.insert(rainbowObjects, {obj = ColorpickerFrameOutline, type = "Background"})
         ...
         function ChannelContent:Textbox(text, placetext, disapper, callback)
            ...
            table.insert(rainbowObjects, {obj = TextboxTitle, type = "Text"})
            ...
            table.insert(rainbowObjects, {obj = TextboxFrameOutline, type = "Background"})
         ...
         function ChannelContent:Label(text)
            ...
            table.insert(rainbowObjects, {obj = LabelTitle, type = "Text"})
         ...
         function ChannelContent:Bind(text, presetbind, callback)
            ...
            Keybind.Size = UDim2.new(1, -10, 0, 32)
            ...
            KeybindTitle.TextColor3 = Color3.fromRGB(185, 187, 190)
            KeybindTitle.TextSize = 14
            KeybindTitle.TextXAlignment = Enum.TextXAlignment.Left
            table.insert(rainbowObjects, {obj = KeybindTitle, type = "Text"})

            -- key text
            KeybindText.Parent = Keybind
            KeybindText.BackgroundTransparency = 1
            KeybindText.Position = UDim2.new(1, -10, 0, 0)
            KeybindText.AnchorPoint = Vector2.new(1, 0)
            KeybindText.Size = UDim2.new(0, 80, 1, 0)
            KeybindText.Font = Enum.Font.GothamSemibold
            KeybindText.Text = presetbind.Name
            KeybindText.TextColor3 = Color3.fromRGB(114, 118, 125)
            KeybindText.TextSize = 14
            KeybindText.TextXAlignment = Enum.TextXAlignment.Right

            Keybind.MouseEnter:Connect(function()
               game:GetService("TweenService"):Create(Keybind, TweenInfo.new(0.15), {
...
local win = PleumPleum:Window("discord library")
...
PleumPleum:Notification("Notification", "Killed everyone!", "Okay!")
end)

btns:Line()

btns:Button("Get max level", function()
PleumPleum:Notification("Notification", "Max level!", "Okay!")
end)
